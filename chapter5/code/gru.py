...
class Model(nn.Module):
    ...
    def forward(self, input):
        ...
        c0 = torch.zeros(self.num_layers, input.size(0), self.hidden_size).cuda()
...
torch.save(model.state_dict(), 'model-0.1' + '.pt')
torch.save(model, 'model-total-0.1' + '.pt')
